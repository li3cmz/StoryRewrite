...
def _default_tfrecord_numpy_dataset_hparams():
    ...
    See :meth:`texar.tf.data.TFRecordNumpyData.default_hparams` for details.
    """
    return {
        "files": [],
...
class TFRecordNumpyData(TFRecordData):
    ...
    See `texar.tf.data.TFRecordData` for details
    """
    ...
    def default_hparams():
        ...
        See `texar.tf.data.TFRecordData.default_hparams` for details
        """
