...
from texar.tf.data.data.multi_aligned_data import _default_dataset_hparams
from texar.tf.data.data.multi_aligned_data import MultiAlignedData
...
class MultiAlignedNumpyData(MultiAlignedData, TextDataBase):
    ...
    See `texar.tf.data.MultiAlignedData` for details.
    """
