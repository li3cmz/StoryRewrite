...
os.environ["CUDA_VISIBLE_DEVICES"] = "{}".format(7)                                                ###modify
...
flags.DEFINE_string('out', 'out_1024_baby_model_1.1_transformer512_auxiliary_loss_1_05_SGT', 'The config to use.')                      ###modify
