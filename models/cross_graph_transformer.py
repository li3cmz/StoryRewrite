...
* forked from texar.tf.modules.decoders.transformer_decoder.TransformerDecoder
...
from texar.tf.modules.encoders.transformer_encoders import default_transformer_poswise_net_hparams
...
class CrossGraphTransformerFixedLengthDecoder(EncoderBase):
    ...
    def _build(self, inputs, memory, sequence_length, memory_sequence_length, encoder_output, adjs=None, mode=None):
        """Encodes the inputs.
