...
class ResidualTransformerEncoder(EncoderBase):
                ...
                with tf.variable_scope("layer_{}".format(i)):
                    ...
                    with tf.variable_scope('attention'):
                        ...
                        if self._hparams.dim != mh_attn.hparams.output_dim:
                            raise ValueError(
                                ...
                                '"dim" of ResidualTransformerEncoder')
                    ...
                    if self._hparams.dim != final_dim:
                        raise ValueError(
                            ...
                            'to the "dim" of ResidualTransformerEncoder.')
    ...
    def _build(self, inputs, memory, sequence_length, memory_sequence_length, mode=None):
        """Encodes the inputs.
        ...
        for i in range(self._hparams.num_blocks):
            with tf.variable_scope("layer_{}".format(i)):
                ...
                with tf.variable_scope(poswise_network.variable_scope, reuse=tf.AUTO_REUSE):
