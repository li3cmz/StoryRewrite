...
def process_single_example(mode, example, max_seq_length_x, max_seq_length_y, tokenizer):
    x1 = tokenizer.tokenize(tokenization.convert_to_unicode(example.x1))
    x2 = tokenizer.tokenize(tokenization.convert_to_unicode(example.x2))
    xx2 = tokenizer.tokenize(tokenization.convert_to_unicode(example.xx2))

    y1 = tokenizer.tokenize(tokenization.convert_to_unicode(example.y1))
    yy1 = tokenizer.tokenize(tokenization.convert_to_unicode(example.yy1))
    y2 = tokenizer.tokenize(tokenization.convert_to_unicode(example.y2))
    yy2 = tokenizer.tokenize(tokenization.convert_to_unicode(example.yy2))
    y3 = tokenizer.tokenize(tokenization.convert_to_unicode(example.y3))
    yy3= tokenizer.tokenize(tokenization.convert_to_unicode(example.yy3))
    #print(example.yy3, tokenization.convert_to_unicode(example.yy3), '----------', yy3)

    input_ids_x1x2, input_mask_x1x2, segment_ids_x1x2,tokens = encode(tokenizer,max_seq_length_x,x1,x2)
    input_ids_x1xx2, input_mask_x1xx2, segment_ids_x1xx2,_ = encode(tokenizer,max_seq_length_x,x1,xx2)
...
def file_based_convert_examples_to_features_v2(mode,
    ...
    for (_, example) in enumerate(examples):
        ...
        features_y["input_ids_yy1"] = _create_int_feature(fea_y["input_ids_yy1"])
        features_y["input_mask_yy1"] = _create_int_feature(fea_y["input_mask_yy1"])
        features_y["segment_ids_yy1"] = _create_int_feature(fea_y["segment_ids_yy1"])
        features_y["input_ids_yy2"] = _create_int_feature(fea_y["input_ids_yy2"])
        features_y["input_mask_yy2"] = _create_int_feature(fea_y["input_mask_yy2"])
        features_y["segment_ids_yy2"] = _create_int_feature(fea_y["segment_ids_yy2"])
        features_y["input_ids_yy3"] = _create_int_feature(fea_y["input_ids_yy3"])
        features_y["input_mask_yy3"] = _create_int_feature(fea_y["input_mask_yy3"])
        features_y["segment_ids_yy3"] = _create_int_feature(fea_y["segment_ids_yy3"])
