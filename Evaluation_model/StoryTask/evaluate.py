...
def main(pred_endings_file, gold_file, bert_model):
    ...
    #print("Eval CFRScore ... ") #余弦相似性
    #metrics.update(eval_rewrite(instances))
    #print("Eval WMD ... ") #余弦相似性
    #metrics.update(eval_wmd(instances))
    #print("Eval Drift Similarity ... ") #余弦相似性
...
if __name__ == '__main__':
    folder = 'out_1020_baby_model_1.1_addSGT_adjustLr_fromEpoch15' ###modify
    epoch = '4' ###modify
    gpu_id=6 ###modify
    os.environ["CUDA_VISIBLE_DEVICES"] = "{}".format(gpu_id)                                                ###modify
    ...
    parser.add_argument('--pred-endings-file', type=str,
                        ...
                        default="./results/{}/story{}_pred.txt".format(folder, epoch))#story{}_pred.txt ###modify
    ...
    parser.add_argument('--gold-file', type=str,
                        ...
                        default="./results/{}/story{}_gt.jsonl".format(folder, epoch))#story{}_gt.jsonl
    ...
    parser.add_argument('--output_file', type=str,
                        dest="output_file",
                        help='',
                        default="./results/{}/output_{}.txt".format(folder, epoch))
