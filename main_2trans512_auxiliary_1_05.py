...
from models.baby_model_2trans512_auxiliary_1_05 import EvolveGTAE                           ###modify                       
...
os.environ["CUDA_VISIBLE_DEVICES"] = "{}".format(1)                                                ###modify
...
# get config
flags = tf.flags
flags.DEFINE_string('config', 'config_storyRw_ctxImrov', 'The config to use.')                              ###modify
flags.DEFINE_string('out', 'out_1024_baby_model_1.1_2transformer512_auxiliary_loss_1_05', 'The config to use.')                      ###modify
